        ...
        <div className='bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto'>
            <form action="">
                ...
                <div className='mb-4'>
                    ...
                    <textarea className='w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-green-500' type="email" name="" id="" placeholder="Your Message...">
